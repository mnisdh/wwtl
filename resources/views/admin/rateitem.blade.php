...
@section('content')
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <ul class="nav nav-pills">
                <li role="presentation"><a href="/admin/ratetype">Rate Type</a></li>
                <li role="presentation" class="active"><a href="/admin/rateitem">Rate Item</a></li>
            </ul>
            <div class="form-inline" id="add-item">
                <select id="sel-ratetype" class="form-control">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <input type="hidden" id="rate_type" value="0" />
            ...
            <% _.each(data, function(v, i){%>
                <tr>
                    <td class="rate_item text-center"><%- v.rate_item %></td>
...
@endsection
@section('scripts')
    <script src="/scripts/views/admin.rateitem.js"></script>
@endsection